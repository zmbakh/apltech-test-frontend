...
import { useProductUpdate } from '@/composables/product/useProductUpdate.ts'
import { NForm, NFormItem, NInput, NInputNumber, NSelect, NButton } from 'naive-ui'

const { fields, submit, loadError, saveError, fieldErrors, loading } = useProductUpdate()
...
defineExpose({ loadError, saveError })
</script>
